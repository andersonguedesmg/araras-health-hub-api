...
;WITH RandomDates (
      ...
      FROM (
         ...
         -- ('Name',                                                  'Description',                                                    'MainCategory',           'SubCategory',                      'PresentationForm',       'IsActive')
            ('Dipirona Sódica 500mg',                                 'Analgésico e Antitérmico.',                                      'Medicamento',            'Analgésico/Antitérmico',           'Comprimido',              1),
            ('Paracetamol 750mg',                                     'Analgésico e Antitérmico.',                                      'Medicamento',            'Analgésico/Antitérmico',           'Comprimido',              1),
            ('Ibuprofeno 600mg',                                      'Anti-inflamatório, Analgésico e Antitérmico.',                   'Medicamento',            'Anti-inflamatório Não Esteroidal', 'Comprimido',              1),
            ('Amoxicilina 500mg',                                     'Antibiótico de amplo espectro.',                                 'Medicamento',            'Antibiótico',                      'Cápsula',                 1),
            ('Cefalexina 250mg/5ml',                                  'Antibiótico, suspensão oral para uso pediátrico.',               'Medicamento',            'Antibiótico',                      'Suspensão',               1),
            ('Omeprazol 20mg',                                        'Inibidor de bomba de prótons, tratamento de úlcera.',            'Medicamento',            'Gastrointestinal',                 'Cápsula',                 1),
            ('Sinvastatina 40mg',                                     'Hipolipemiante, controle de colesterol.',                        'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ...
            ('Cloridrato de Fluoxetina 20mg',                         'Antidepressivo, Inibidor Seletivo de Recaptação de Serotonina.', 'Medicamento',            'Psicotrópico',                     'Cápsula',                 1),
            ('Diazepam 10mg',                                         'Ansiolítico e sedativo, controle de ansiedade.',                 'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Insulina NPH 100 UI/ml',                                'Para controle de Diabetes Mellitus.',                            'Medicamento',            'Hormonal/Endócrino',               'Frasco-ampola',           1),
            ('Hidrocortisona 100mg',                                  'Corticosteroide injetável para emergências.',                    'Medicamento',            'Corticosteroide',                  'Ampola',                  1),
            ('Dipirona Sódica 500mg/ml',                              'Analgésico e Antitérmico intravenoso/intramuscular.',            'Medicamento',            'Analgésico/Antitérmico',           'Ampola',                  1),
            ('Ondansetrona 8mg',                                      'Anti-emético, para prevenção de náuseas e vômitos.',             'Medicamento',            'Gastrointestinal',                 'Comprimido',              1),
            ('Azitromicina 500mg',                                    'Antibiótico Macrolídeo.',                                        'Medicamento',            'Antibiótico',                      'Comprimido',              1),
            ('Penicilina Benzatina 1.200.000 UI',                     'Antibiótico de depósito, injeção intramuscular.',                'Medicamento',            'Antibiótico',                      'Frasco',                  1),
            ('Adrenalina (Epinefrina) 1mg/ml',                        'Vaso constritor, para emergências',                              'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Lidocaína 2% sem Vasoconstritor',                       'Anestésico local.',                                              'Medicamento',            'Anestésico',                       'Frasco-ampola',           1),
            ('Soro Fisiológico 0,9%',                                 'Solução para reidratação e diluição de medicamentos.',           'Medicamento',            'Solução Parenteral',               'Bolsa 500ml',             1),
            ('Soro Glicosado 5%',                                     'Solução para hidratação e aporte calórico.',                     'Medicamento',            'Solução Parenteral',               'Bolsa 500ml',             1),
            ...
            ('Cloreto de Potássio (KCl) 19,1%',                       'Repositor eletrolítico.',                                        'Medicamento',            'Eletrolítico',                     'Ampola',                  1),
            ('Sulfato Ferroso 40mg',                                  'Suplemento para tratamento de anemia.',                          'Medicamento',            'Suplemento/Vitamina',              'Comprimido',              1),
            ('Metoclopramida 10mg',                                   'Anti-emético e Procinético.',                                    'Medicamento',            'Gastrointestinal',                 'Comprimido',              1),
            ('Tramadol 50mg',                                         'Analgésico opioide de ação central.',                            'Medicamento',            'Analgésico/Opioide',               'Comprimido',              1),
            ('Morfina 10mg',                                          'Analgésico opioide potente.',                                    'Medicamento',            'Analgésico/Opioide',               'Ampola',                  1),
            ('Captopril 25mg',                                        'Anti-hipertensivo, Inibidor da ECA.',                            'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Furosemida 40mg',                                       'Diurético de alça.',                                             'Medicamento',            'Renal/Diurético',                  'Comprimido',              1),
            ('Sertralina 50mg',                                       'Antidepressivo ISRS.',                                           'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ...
            ('Nistatina Suspensão Oral',                              'Antifúngico, para candidíase oral.',                             'Medicamento',            'Antifúngico',                      'Frasco',                  1),
            ('Cetoconazol 200mg',                                     'Antifúngico sistêmico.',                                         'Medicamento',            'Antifúngico',                      'Comprimido',              1),
            ('Propranolol 40mg',                                      'Betabloqueador, anti-hipertensivo e anti-anginoso.',             'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('AAS (Ácido Acetilsalicílico) 100mg',                    'Antiagregante plaquetário.',                                     'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Propofol 10mg/ml',                                      'Anestésico geral intravenoso.',                                  'Medicamento',            'Anestésico',                       'Frasco-ampola',           1),
            ('Sevoflurano',                                           'Anestésico volátil inalatório.',                                 'Medicamento',            'Anestésico',                       'Frasco',                  1),
            ('Pancurônio',                                            'Bloqueador neuromuscular não despolarizante.',                   'Medicamento',            'Anestésico',                       'Ampola',                  1),
            ('Rocurônio',                                             'Bloqueador neuromuscular de ação rápida.',                       'Medicamento',            'Anestésico',                       'Frasco-ampola',           1),
            ('Soro Ringer Lactato',                                   'Solução para reposição hidroeletrolítica e alcalinizante.',      'Medicamento',            'Solução Parenteral',               'Bolsa 1000ml',            1),
            ('Soro Glicosado 10%',                                    'Solução de glicose para nutrição ou correção de hipoglicemia.',  'Medicamento',            'Solução Parenteral',               'Bolsa 500ml',             1),
            ...
            ('Nifedipino 10mg',                                       'Bloqueador de canal de cálcio, anti-hipertensivo.',              'Medicamento',            'Cardiovascular',                   'Cápsula',                 1),
            ('Digoxina 0,25mg',                                       'Glicosídeo cardíaco, para insuficiência e arritmias.',           'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Espironolactona 25mg',                                  'Diurético poupador de potássio.',                                'Medicamento',            'Renal/Diurético',                  'Comprimido',              1),
            ('Clonazepam 0,5mg',                                      'Anticonvulsivante e ansiolítico.',                               'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Carbonato de Cálcio 500mg',                             'Suplemento de cálcio.',                                          'Medicamento',            'Suplemento/Vitamina',              'Comprimido',              1),
            ('Fenobarbital 100mg',                                    'Anticonvulsivante, barbitúrico.',                                'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Metronidazol 400mg',                                    'Antiprotozoário e antibiótico (anaeróbios).',                    'Medicamento',            'Antimicrobiano',                   'Comprimido',              1),
            ('Fluconazol 150mg',                                      'Antifúngico oral de dose única.',                                'Medicamento',            'Antifúngico',                      'Cápsula',                 1),
            ('Glibenclamida 5mg',                                     'Antidiabético oral, Sulfonilureia.',                             'Medicamento',            'Hormonal/Endócrino',               'Comprimido',              1),
            ('Levotiroxina Sódica 100mcg',                            'Hormônio tireoidiano.',                                          'Medicamento',            'Hormonal/Endócrino',               'Comprimido',              1),
            ('Glicose em Gel',                                        'Para hipoglicemia leve/moderada.',                               'Medicamento',            'Emergência',                       'Sachê',                   1),
            ('Naloxona 0,4mg/ml',                                     'Antagonista opioide, para overdose.',                            'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Flumazenil 0,1mg/ml',                                   'Antagonista Benzodiazepínico.',                                  'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Heparina Sódica 5000 UI/ml',                            'Anticoagulante injetável.',                                      'Medicamento',            'Hematológico',                     'Frasco',                  1),
            ('Varfarina Sódica 5mg',                                  'Anticoagulante oral.',                                           'Medicamento',            'Hematológico',                     'Comprimido',              1),
            ('Dipirona Gotas 500mg/ml',                               'Analgésico e Antitérmico.',                                      'Medicamento',            'Analgésico/Antitérmico',           'Frasco Gotas',            1),
            ('Paracetamol Xarope 32mg/ml',                            'Analgésico e Antitérmico.',                                      'Medicamento',            'Analgésico/Antitérmico',           'Frasco Xarope',           1),
            ('Metildopa 250mg',                                       'Anti-hipertensivo central, para gestantes.',                     'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ...
            ('Nitroglicerina Sublingual 0,5mg',                       'Vaso dilatador coronariano, para angina.',                       'Medicamento',            'Emergência',                       'Comprimido Sublingual',   1),
            ('Alopurinol 300mg',                                      'Para tratamento da Gota.',                                       'Medicamento',            'Reumatológico',                    'Comprimido',              1),
            ('Colchicina 0,5mg',                                      'Para crise aguda de Gota.',                                      'Medicamento',            'Reumatológico',                    'Comprimido',              1),
            ('Prednisona 20mg',                                       'Corticosteroide oral.',                                          'Medicamento',            'Corticosteroide',                  'Comprimido',              1),
            ('Fentanil 50mcg/ml',                                     'Analgésico opioide sintético.',                                  'Medicamento',            'Analgésico/Opioide',               'Ampola',                  1),
            ('Midazolam 5mg/ml',                                      'Sedativo e ansiolítico injetável.',                              'Medicamento',            'Psicotrópico',                     'Ampola',                  1),
            ('Haloperidol 5mg',                                       'Antipsicótico.',                                                 'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ...
            ('Lactulose Xarope',                                      'Laxante e para encefalopatia hepática.',                         'Medicamento',            'Gastrointestinal',                 'Frasco Xarope',           1),
            ('Bissacodil 5mg',                                        'Laxante estimulante.',                                           'Medicamento',            'Gastrointestinal',                 'Comprimido',              1),
            ('Baclofeno 10mg',                                        'Relaxante muscular.',                                            'Medicamento',            'Musculoesquelético',               'Comprimido',              1),
            ('Ciclobenzaprina 10mg',                                  'Relaxante muscular.',                                            'Medicamento',            'Musculoesquelético',               'Comprimido',              1),
            ('Metocarbamol 750mg',                                    'Relaxante muscular.',                                            'Medicamento',            'Musculoesquelético',               'Comprimido',              1),
            ('Cefazolina 1g',                                         'Antibiótico Cefalosporina de 1ª geração.',                       'Medicamento',            'Antibiótico',                      'Frasco-ampola',           1),
            ('Ceftriaxona 1g',                                        'Antibiótico Cefalosporina de 3ª geração.',                       'Medicamento',            'Antibiótico',                      'Frasco-ampola',           1),
            ('Sulfato de Magnésio 50%',                               'Para eclâmpsia e reposição de magnésio.',                        'Medicamento',            'Eletrolítico',                     'Ampola',                  1),
            ...
            ('Gliclazida 60mg',                                       'Antidiabético oral, Sulfonilureia de nova geração.',             'Medicamento',            'Hormonal/Endócrino',               'Comprimido',              1),
            ...
            ('Amlodipino 5mg',                                        'Bloqueador de canal de cálcio, anti-hipertensivo.',              'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Ramipril 5mg',                                          'Inibidor da ECA.',                                               'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Insulina Regular 100 UI/ml',                            'Insulina de curta ação.',                                        'Medicamento',            'Hormonal/Endócrino',               'Frasco-ampola',           1),
            ('Insulina Glargina 100 UI/ml',                           'Insulina de ação prolongada.',                                   'Medicamento',            'Hormonal/Endócrino',               'Caneta',                  1),
            ...
            ('Ácido Fólico 5mg',                                      'Suplemento vitamínico.',                                         'Medicamento',            'Suplemento/Vitamina',              'Comprimido',              1),
            ('Vitamina D 10.000 UI',                                  'Suplemento vitamínico.',                                         'Medicamento',            'Suplemento/Vitamina',              'Cápsula',                 1),
            ('Latanoprost 0,005%',                                    'Para glaucoma, uso oftálmico.',                                  'Medicamento',            'Oftálmico/Otorrinolaringológico',  'Frasco Gotas',            1),
            ('Papaverina 40mg',                                       'Antiespasmódico.',                                               'Medicamento',            'Gastrointestinal',                 'Ampola',                  1),
            ('Hioscina (Butilescopolamina) 10mg',                     'Antiespasmódico.',                                               'Medicamento',            'Gastrointestinal',                 'Comprimido',              1),
            ('Dobutamina 250mg',                                      'Agente inotrópico, para choque cardiogênico.',                   'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Norepinefrina (Noradrenalina) 4mg',                     'Vaso constritor, para choque séptico.',                          'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Tiamina (Vitamina B1) 300mg',                           'Para Síndrome de Wernicke-Korsakoff.',                           'Medicamento',            'Suplemento/Vitamina',              'Comprimido',              1),
            ('Sulfato de Atropina 0,25mg/ml',                         'Anticolinérgico, para bradicardia.',                             'Medicamento',            'Emergência',                       'Ampola',                  1),
            ...
            ('Cloreto de Sódio 20%',                                  'Repositor eletrolítico (Sódio).',                                'Medicamento',            'Eletrolítico',                     'Ampola',                  1),
            ('Bicarbonato de Sódio 8,4%',                             'Para acidose metabólica.',                                       'Medicamento',            'Eletrolítico',                     'Ampola',                  1),
            ('Dopamina 50mg/ml',                                      'Para choque cardiogênico.',                                      'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Etomidato 2mg/ml',                                      'Hipnótico para intubação.',                                      'Medicamento',            'Anestésico',                       'Ampola',                  1),
            ('Sufentanil 50mcg/ml',                                   'Analgésico opioide potente.',                                    'Medicamento',            'Analgésico/Opioide',               'Ampola',                  1),
            ('Soro Fisiológico 0,45%',                                'Solução hipotônica, para hipernatremia.',                        'Medicamento',            'Solução Parenteral',               'Bolsa 500ml',             1),
            ('Soro Glicosado 25%',                                    'Solução hipertônica de glicose.',                                'Medicamento',            'Solução Parenteral',               'Ampola',                  1),
            ('Cetoprofeno 100mg',                                     'Anti-inflamatório Não Esteroidal.',                              'Medicamento',            'Anti-inflamatório Não Esteroidal', 'Comprimido',              1),
            ...
            ('Tenoxicam 20mg',                                        'Anti-inflamatório Não Esteroidal.',                              'Medicamento',            'Anti-inflamatório Não Esteroidal', 'Comprimido',              1),
            ('Meloxicam 15mg',                                        'Anti-inflamatório Não Esteroidal.',                              'Medicamento',            'Anti-inflamatório Não Esteroidal', 'Comprimido',              1),
            ('Fenitoína 100mg',                                       'Anticonvulsivante.',                                             'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Levetiracetam 500mg',                                   'Anticonvulsivante de nova geração.',                             'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Risperidona 2mg',                                       'Antipsicótico atípico.',                                         'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Quetiapina 50mg',                                       'Antipsicótico atípico.',                                         'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Olanzapina 10mg',                                       'Antipsicótico atípico.',                                         'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Doxiciclina 100mg',                                     'Antibiótico Tetraciclina.',                                      'Medicamento',            'Antibiótico',                      'Cápsula',                 1),
            ('Clindamicina 300mg',                                    'Antibiótico Lincosamida.',                                       'Medicamento',            'Antibiótico',                      'Cápsula',                 1),
            ('Claritromicina 500mg',                                  'Antibiótico Macrolídeo.',                                        'Medicamento',            'Antibiótico',                      'Comprimido',              1),
            ('Levofloxacino 500mg',                                   'Antibiótico Quinolona.',                                         'Medicamento',            'Antibiótico',                      'Comprimido',              1),
            ('Ácido Tranexâmico 250mg',                               'Anti-fibrinolítico, para controle de sangramento.',              'Medicamento',            'Hematológico',                     'Comprimido',              1),
            ('Fita Adesiva Transparente (Durex Grande)',              'Para uso geral.',                                                'Material de Escritório', 'Uso Geral',                        'Rolo',                    1),
            ('Fitomenadiona (Vitamina K) 10mg',                       'Para coagulação e reversão de anticoagulantes.',                 'Medicamento',            'Hematológico',                     'Ampola',                  1),
            ('Imunoglobulina Humana',                                 'Para imunodeficiências.',                                        'Medicamento',            'Imunológico',                      'Frasco',                  1),
            ('Etanercepte',                                           'Imunossupressor biológico.',                                     'Medicamento',            'Reumatológico',                    'Seringa Pré-Enchida',     1),
            ('Metotrexato 2,5mg',                                     'Imunossupressor e quimioterápico.',                              'Medicamento',            'Reumatológico/Oncológico',         'Comprimido',              1),
            ('Cisplatina 50mg',                                       'Quimioterápico.',                                                'Medicamento',            'Oncológico',                       'Frasco-ampola',           1),
            ('Extensão Elétrica de 3 Metros',                         'Para uso em consultórios.',                                      'Material de Escritório', 'Suprimento',                       'Unidade',                 1),
            ('Doxorrubicina 50mg',                                    'Quimioterápico.',                                                'Medicamento',            'Oncológico',                       'Frasco-ampola',           1),
            ('Paclitaxel 100mg',                                      'Quimioterápico.',                                                'Medicamento',            'Oncológico',                       'Frasco-ampola',           1),
            ('Tamoxifeno 20mg',                                       'Hormônio modulador seletivo do receptor de estrogênio.',         'Medicamento',            'Oncológico/Hormonal',              'Comprimido',              1),
            ('Tibolona 2,5mg',                                        'Terapia de reposição hormonal.',                                 'Medicamento',            'Hormonal/Endócrino',               'Comprimido',              1),
            ('Progesterona Injetável',                                'Hormônio progestagênio.',                                        'Medicamento',            'Hormonal/Endócrino',               'Ampola',                  1),
            ('Desmopressina 0,1mg',                                   'Para diabetes insipidus e hemofilia.',                           'Medicamento',            'Hormonal/Endócrino',               'Comprimido',              1),
            ('Oxímetro de Pulso',                                     'Para medição não invasiva da saturação de oxigênio.',            'Material Hospitalar',    'Equipamento',                      'Unidade',                 1),
            ('Enoxaparina 40mg',                                      'Anticoagulante (Heparina de Baixo Peso Molecular).',             'Medicamento',            'Hematológico',                     'Seringa Pré-Enchida',     1),
            ...
            ('Amoxicilina 250mg/5ml',                                 'Antibiótico de amplo espectro, suspensão pediátrica.',           'Medicamento',            'Antibiótico',                      'Suspensão',               1),
            ...
            ('Diazepam 5mg',                                          'Ansiolítico e sedativo.',                                        'Medicamento',            'Psicotrópico',                     'Comprimido',              1),
            ('Fita Demarcadora para Piso (Amarela)',                  'Para sinalização de segurança.',                                 'Material de Limpeza',    'Acessório',                        'Rolo',                    1),
            ('Hidrocortisona 500mg',                                  'Corticosteroide injetável para emergências.',                    'Medicamento',            'Corticosteroide',                  'Frasco-ampola',           1),
            ...
            ('Ondansetrona 4mg',                                      'Anti-emético.',                                                  'Medicamento',            'Gastrointestinal',                 'Comprimido',              1),
            ('Azitromicina 250mg',                                    'Antibiótico Macrolídeo.',                                        'Medicamento',            'Antibiótico',                      'Comprimido',              1),
            ('Lidocaína 1%',                                          'Anestésico local.',                                              'Medicamento',            'Anestésico',                       'Frasco-ampola',           1),
            ('Soro Fisiológico 0,9%',                                 'Solução para diluição.',                                         'Medicamento',            'Solução Parenteral',               'Bolsa 250ml',             1),
            ('Soro Glicosado 5%',                                     'Solução para hidratação.',                                       'Medicamento',            'Solução Parenteral',               'Bolsa 100ml',             1),
            ('Cloreto de Potássio (KCl) 10%',                         'Repositor eletrolítico, concentração menor.',                    'Medicamento',            'Eletrolítico',                     'Ampola',                  1),
            ('Captopril 50mg',                                        'Anti-hipertensivo, Inibidor da ECA.',                            'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Furosemida 20mg',                                       'Diurético de alça.',                                             'Medicamento',            'Renal/Diurético',                  'Comprimido',              1),
            ...
            ('AAS (Ácido Acetilsalicílico) 500mg',                    'Analgésico e Anti-inflamatório.',                                'Medicamento',            'Analgésico/Antitérmico',           'Comprimido',              1),
            ('Digoxina 0,125mg',                                      'Glicosídeo cardíaco.',                                           'Medicamento',            'Cardiovascular',                   'Comprimido',              1),
            ('Clonazepam Gotas',                                      'Anticonvulsivante e ansiolítico.',                               'Medicamento',            'Psicotrópico',                     'Frasco Gotas',            1),
            ('Metronidazol Solução Injetável',                        'Antiprotozoário e antibiótico.',                                 'Medicamento',            'Antimicrobiano',                   'Bolsa 100ml',             1),
            ('Flumazenil Solução Injetável',                          'Antagonista Benzodiazepínico.',                                  'Medicamento',            'Emergência',                       'Ampola',                  1),
            ('Heparina Sódica 5000 UI',                               'Anticoagulante em dose única.',                                  'Medicamento',            'Hematológico',                     'Frasco-ampola',           1),
...

{
  ...
  "receivedItems": [
    ...
    { "quantity": 1300, "unitValue": 0.55, "batch": "LOTD6E7F8G9", "expiryDate": "2027-08-29", "productId": 215 },
...

{
  ...
  "receivedItems": [
    ...
    { "quantity": 250, "unitValue": 53.00, "batch": "LOTR6S7T8U9", "expiryDate": "2028-08-22", "productId": 317 },
    { "quantity": 10, "unitValue": 124.00, "batch": "LOTV0W1X2Y3", "expiryDate": "2026-09-16", "productId": 326 },
...

{
  ...
  "receivedItems": [
    ...
    { "quantity": 300, "unitValue": 2.95, "batch": "LOTJ8K0L2M4", "expiryDate": "2027-05-09", "productId": 198 },
...

{
  ...
  "receivedItems": [
    ...
    { "quantity": 300, "unitValue": 2.15, "batch": "LOTR8S9T0U1", "expiryDate": "2029-06-15", "productId": 294 },
