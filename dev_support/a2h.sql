...
;WITH RandomDates (
      ...
      FROM (
         ...
         -- ('Name',                                            'Description',                                                          'MainCategory',                        'SubCategory',                      'PresentationForm',    'IsActive')
            ...
            ('Pilha Alcalina Palito AAA',                       'Pilha AAA para dispositivos clínicos.',                                'Material Hospitalar',                 'Acessórios',                       'Unidade',              1),
            ('Pilha Alcalina Pequena AA',                       'Pilha AA para equipamentos médicos.',                                  'Material Hospitalar',                 'Acessórios',                       'Unidade',              1),
            ...
            ('Extensão Elétrica de 3 Metros',                   'Para uso em consultórios.',                                            'Material de Apoio e Administrativo',  'Suprimento',                       'Unidade',              1),
            ...
            ('Papel Térmico ECG 210mm x 30m',                   'Papel sensível para eletrocardiógrafo.',                               'Material Hospitalar',                 'Material de Consumo Descartável',  'Rolo 30m',             1),
            ...
            ('Sonda Retal Nº04',                                'Sonda flexível para administração retal.',                             'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Papel Sulfite A4 75g',                            'Para impressão de laudos, receitas e prontuários.',                    'Material de Apoio e Administrativo',  'Registro/Documentação',            'Caixa 5 resmas',       1),
            ...
            ('Toner para Impressora Laser',                     'Suprimento de impressão.',                                             'Material de Apoio e Administrativo',  'Suprimento',                       'Unidade',              0),
            ('Cartucho de Tinta Preto',                         'Suprimento de impressão.',                                             'Material de Apoio e Administrativo',  'Suprimento',                       'Unidade',              0),
            ...
            ('Luva de Borracha Tamanho G',                      'Para proteção das mãos do pessoal da limpeza.',                        'Material de Limpeza',                 'EPI',                              'Unidade',              1),
            ...
            ('Pilha Alcalina Grande',                           'Pilha tipo D para equipamentos.',                                      'Material Hospitalar',                 'Acessórios',                       'Unidade',              1),
            ...
            ('Pilha Alcalina AA',                               'Para equipamentos (mouse sem fio, termômetro).',                       'Material de Apoio e Administrativo',  'Suprimento',                       'Cartela 4 unidades',   0),
            ('Pilha Alcalina AAA',                              'Para equipamentos (controle remoto, lanterna).',                       'Material de Apoio e Administrativo',  'Suprimento',                       'Cartela 4 unidades',   0),
            ...
            ('Hipoclorito 2,5% 5L',                             'Desinfecção de uso geral e sanitários.',                               'Material de Limpeza',                 'Produto Químico',                  'Galão',                1),
            ('Detergente Neutro para Louças 5L',                'Limpeza de utensílios de cozinha.',                                    'Material de Limpeza',                 'Produto Químico',                  'Galão',                1),
            ('Luva de Borracha Tamanho M',                      'Para proteção das mãos do pessoal da limpeza.',                        'Material de Limpeza',                 'EPI',                              'Unidade',              1),
            ...
            ('Sonda Foley 2 Vias Nº20',                         'Sonda para drenagem urinária.',                                        'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Nebulizador',                                     'Aparelho para administração de aerossóis terapêuticos.',               'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Avental Impermeável de PVC ',                     'Proteção contra respingos de líquidos.',                               'Material de Limpeza',                 'EPI',                              'Unidade',              1),
            ...
            ('Calçados de Segurança Antiderrapantes',           'Para proteger os pés do trabalhador e evitar quedas.',                 'Material de Limpeza',                 'EPI',                              'Unidade',              1),
            ('Botas de Borracha',                               'Proteger contra grandes volumes de água.',                             'Material de Limpeza',                 'EPI',                              'Unidade',              1),
            ...
            ('Cânula de Guedel Nº4',                            'Cânula orofaríngea para suporte ventilatório.',                        'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Cânula de Guedel Nº5',                            'Cânula orofaríngea para ventilação assistida.',                        'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Sonda Foley 3 Vias Nº20',                         'Sonda para lavagem vesical contínua.',                                 'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Sonda Foley 3 Vias Nº24',                         'Sonda de grande calibre para irrigação vesical.',                      'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Sonda Nasogástrica Longa Nº08',                   'Sonda para drenagem gástrica.',                                        'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Nasogástrica Longa Nº18',                   'Sonda de grande calibre para drenagem.',                               'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Nasogástrica Longa Nº20',                   'Sonda para drenagem gástrica.',                                        'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Nasogástrica Longa Nº22',                   'Sonda de alto calibre para drenagem.',                                 'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Retal Nº06',                                'Sonda para terapias retais.',                                          'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Retal Nº08',                                'Sonda retal de uso geral.',                                            'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Sonda Retal Nº24',                                'Sonda de grosso calibre.',                                             'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Retal Nº28',                                'Sonda para drenagem alta.',                                            'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Retal Nº30',                                'Sonda de alto calibre para drenagem.',                                 'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Uretral Nº04',                              'Sonda para sondagem uretral masculina ou feminina.',                   'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Sonda Uretral Nº06',                              'Sonda uretral de pequeno calibre.',                                    'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ...
            ('Luva Nitrílica Procedimento M',                   'Luva nitrílica não estéril.',                                          'Material Hospitalar',                 'EPI',                              'Caixa',                1),
            ('Luva Nitrílica Procedimento P',                   'Luva nitrílica tamanho P.',                                            'Material Hospitalar',                 'EPI',                              'Caixa',                1),
            ('Luva Vinil Procedimento P',                       'Luva de vinil para procedimentos.',                                    'Material Hospitalar',                 'EPI',                              'Caixa',                1),
            ('Luva Extra Pequena Látex',                        'Luva de látex tamanho extra pequeno.',                                 'Material Hospitalar',                 'EPI',                              'Caixa',                1),
            ('Máscara Venturi Adulto',                          'Máscara para oxigenoterapia controlada.',                              'Material Hospitalar',                 'Respiratório',                     'Unidade',              1),
            ('Máscara Venturi Infantil',                        'Máscara pediátrica para oxigenoterapia.',                              'Material Hospitalar',                 'Respiratório',                     'Unidade',              1),
            ('Máscara Laríngea Nº3',                            'Máscara supraglótica para via aérea.',                                 'Material Hospitalar',                 'Material de Consumo Descartável',  'Unidade',              1),
            ('Máscara Nebulização Adulto',                      'Máscara para nebulização adulta.',                                     'Material Hospitalar',                 'Respiratório',                     'Unidade',              1),
            ('Máscara Nebulização Infantil',                    'Máscara infantil para inalação.',                                      'Material Hospitalar',                 'Respiratório',                     'Unidade',              1),
            ('Caneta Extra Fina para ECG',                      'Caneta marcador para traçado de ECG.',                                 'Material Hospitalar',                 'Diagnóstico',                      'Unidade',              1),
            ('Bateria para Aparelho de Dextro',                 'Bateria para glicosímetro.',                                           'Material Hospitalar',                 'Acessórios de Diagnóstico',        'Unidade',              1),
            ('Bateria LR41 para Termômetro',                    'Bateria tipo botão para termômetros.',                                 'Material Hospitalar',                 'Acessórios de Diagnóstico',        'Unidade',              1),
            ('Caixa Porta Lâmina Plástico',                     'Caixa para descarte seguro de lâminas.',                               'Material Hospitalar',                 'Descartáveis',                     'Unidade',              1),
            ('Espéculo Descartável M',                          'Espéculo ginecológico tamanho M.',                                     'Material Hospitalar',                 'Ginecologia',                      'Unidade',              1),
            ('Espéculo Descartável P',                          'Espéculo ginecológico tamanho P.',                                     'Material Hospitalar',                 'Ginecologia',                      'Unidade',              1),
            ('Frasco Nutrição Enteral 300ml',                   'Frasco plástico para administração enteral.',                          'Material Hospitalar',                 'Nutrição Enteral',                 'Frasco 300ml',         1),
            ('Kit Venturi Completo Infantil',                   'Conjunto para oferta de oxigenoterapia controlada.',                   'Material Hospitalar',                 'Respiratório',                     'Kit',                  1),
            ('Kit Papanicolau Tamanho G',                       'Kit completo para coleta citológica ginecológica.',                    'Material Hospitalar',                 'Ginecologia',                      'Kit',                  1),
            ('Kit Papanicolau Tamanho M',                       'Kit para coleta de citologia ginecológica.',                           'Material Hospitalar',                 'Ginecologia',                      'Kit',                  1),
            ('Lâmpada LED 12V/50W',                             'Lâmpada LED para equipamentos médicos.',                               'Material Hospitalar',                 'Acessórios',                       'Unidade',              1),
            ('Lanterna Clínica',                                'Lanterna portátil para avaliação clínica.',                            'Material Hospitalar',                 'Diagnóstico',                      'Unidade',              1),
            ('Papel Grau Cirúrgico 10cm',                       'Papel para embalagens de esterilização.',                              'Material Hospitalar',                 'Esterilização',                    'Rolo 10cm',            1),
            ('Papel Grau Cirúrgico 15cm',                       'Papel para esterilização em autoclave.',                               'Material Hospitalar',                 'Esterilização',                    'Rolo 15cm',            1),
            ('Papel Grau Cirúrgico 20cm',                       'Papel grau cirúrgico para embalagens hospitalares.',                   'Material Hospitalar',                 'Esterilização',                    'Rolo 20cm',            1),
            ('Papel Grau Cirúrgico 5cm',                        'Papel para embalagem de instrumentais pequenos.',                      'Material Hospitalar',                 'Esterilização',                    'Rolo 5cm',             1),
            ('Papel Termo 110mm x 20m Vídeo Print',             'Papel termosensível para exames de imagem.',                           'Material Hospitalar',                 'Diagnóstico',                      'Rolo 20m',             1),
            ('Papel Termossensível ECG 80mm x 20m',             'Papel para impressões de ECG portátil.',                               'Material Hospitalar',                 'Diagnóstico',                      'Rolo 20m',             1),
            ('Papel Termossensível Cardiotógrafo 150x90x150',   'Papel para registro de cardiotocografia.',                             'Material Hospitalar',                 'Diagnóstico',                      'Bloco',                1),
            ('Pilha Alcalina Média C',                          'Pilha alcalina tamanho C.',                                            'Material Hospitalar',                 'Acessórios',                       'Unidade',              1),
            ('Polifix 2 Vias',                                  'Conector para infusão intravenosa.',                                   'Material Hospitalar',                 'Infusão',                          'Unidade',              1),
            ('Termo Higrômetro',                                'Aparelho para medir temperatura e umidade.',                           'Material Hospitalar',                 'Diagnóstico',                      'Unidade',              1),
            ('Torneira 3 Vias',                                 'Conector para infusão intravenosa.',                                   'Material Hospitalar',                 'Infusão',                          'Unidade',              1),
            ...
            ('Dispositivo Intrauterino',                        'DIU para contracepção de longa duração.',                              'Material Hospitalar',                 'Ginecologia',                      'Unidade',              1),
            ('Equipo Macrogotas com Injetor Lateral',           'Equipo para administração de soluções IV.',                            'Material Hospitalar',                 'Infusão',                          'Unidade',              1),
            ('Equipo Microgotas com Látex',                     'Equipo microgotas com conector látex.',                                'Material Hospitalar',                 'Infusão',                          'Unidade',              1),
            ('Equipo Nutrição Enteral',                         'Equipo específico para administração enteral.',                        'Material Hospitalar',                 'Nutrição Enteral',                 'Unidade',              1),
            ('Escova Degermação com Clorexidina',               'Escova com antisséptico para preparo cirúrgico das mãos.',             'Material Hospitalar',                 'Antissépticos',                    'Unidade',              1),
            ('Escova para Exames Ginecológicos',                'Escova para coleta de citologia.',                                     'Material Hospitalar',                 'Ginecologia',                      'Unidade',              1),
            ('Fita Micropore 100x10',                           'Fita microporosa para fixação delicada.',                              'Material Hospitalar',                 'Fixação',                          'Rolo 100mm',           1),
            ('Fita Adesiva Branca',                             'Fita adesiva multiuso.',                                               'Material Hospitalar',                 'Fixação',                          'Rolo',                 1)
