...
;WITH RandomDates (
      ...
      FROM (
         ...
         -- ('Name',                                            'Description',                                                          'MainCategory',                        'SubCategory',                       'PresentationForm',    'IsActive')
            ...
            ('Extensão Elétrica de 3 Metros',                   'Para uso em consultórios.',                                            'Material de Apoio e Administrativo',  'Acessórios',                        'Unidade',              1),
            ...
            ('Toner para Impressora Laser',                     'Suprimento de impressão.',                                             'Material de Apoio e Administrativo',  'Acessórios',                        'Unidade',              0),
            ('Cartucho de Tinta Preto',                         'Suprimento de impressão.',                                             'Material de Apoio e Administrativo',  'Acessórios',                        'Unidade',              0),
            ...
            ('Pilha Alcalina AA',                               'Para equipamentos (mouse sem fio, termômetro).',                       'Material de Apoio e Administrativo',  'Acessórios',                        'Cartela 4 unidades',   0),
            ('Pilha Alcalina AAA',                              'Para equipamentos (controle remoto, lanterna).',                       'Material de Apoio e Administrativo',  'Acessórios',                        'Cartela 4 unidades',   0),
            ...
            ('Lâmpada LED 12V/50W',                             'Lâmpada LED para equipamentos médicos.',                               'Material de Apoio e Administrativo',  'Acessórios',                        'Unidade',              1),
            ('Lanterna Clínica',                                'Lanterna portátil para avaliação clínica.',                            'Material de Apoio e Administrativo',  'Diagnóstico',                       'Unidade',              1),
            ...
            ('Pilha Alcalina Média C',                          'Pilha alcalina tamanho C.',                                            'Material de Apoio e Administrativo',  'Acessórios',                        'Unidade',              1),
            ('Polifix 2 Vias',                                  'Conector para infusão intravenosa.',                                   'Material Hospitalar',                 'Material de Consumo Descartável',   'Unidade',              1),
            ('Termo Higrômetro',                                'Aparelho para medir temperatura e umidade.',                           'Material Hospitalar',                 'Acessórios',                        'Unidade',              0),
