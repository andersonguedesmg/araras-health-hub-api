      ...
      FROM (
            VALUES
               -- ('Name',                             'MainCategoryId',  'IsActive')
                  ('Antipsicótico',                     2,                 1),
                  ('Material de Consumo Descartável',   5,                 1),
                  ('Acessório',                         4,                 1),
                  ('AINE',                              2,                 1),
                  ('Anestésico',                        2,                 0),
                  ('Antiparkinsoniano',                 2,                 1),
                  ('Papelaria e Impressos',             6,                 1),
                  ('Antialérgico',                      2,                 1),
                  ('Anticonvulsivante/Eletrólito',      2,                 1),
                  ('Hormonal/Endócrino',                2,                 1),
                  ('Higiene Pessoal',                   5,                 1),
                  ('Antitérmico',                       2,                 1),
                  ('Antidepressivo Tricíclico',         2,                 1),
                  ('Equipamento de Diagnóstico',        4,                 1),
                  ('Higiene',                           4,                 0),
                  ('Anticonvulsivante',                 2,                 1),
                  ('Antivertiginoso',                   2,                 1),
                  ('Antifúngico',                       2,                 1),
                  ('Anti-inflamatório Não Esteroidal',  2,                 0),
                  ('Inotrópico Cardíaco',               2,                 1),
                  ('Anticoagulante',                    2,                 1),
                  ('Antiespasmódico',                   2,                 1),
                  ('EPI',                               5,                 0),
                  ('EPI - Descartável',                 4,                 1),
                  ('Suplemento Mineral',                2,                 1),
                  ('Anestesia',                         2,                 1),
                  ('Uso Geral',                         6,                 1),
                  ('Gastrointestinal',                  2,                 1),
                  ('Analgésico/Antitérmico',            2,                 1),
                  ('Dermatológico',                     2,                 1),
                  ('Suprimentos Gerais',                4,                 1),
                  ('Higiene',                           5,                 0),
                  ('Corticosteroide',                   2,                 1),
                  ('Vitamina',                          2,                 1),
                  ('Psicotrópico',                      2,                 1),
                  ...
                  ('Antibiótico',                       2,                 1),
                  ('Energia e TI',                      6,                 1),
                  ('Material de Apoio',                 4,                 1),
                  ('Estabilizador de Humor',            2,                 1),
                  ('Documentação',                      6,                 0),
                  ('Detergente',                        5,                 0),
                  ('Instrumental',                      4,                 0),
                  ('Diurético',                         2,                 1),
                  ('Ansiolítico',                       2,                 1),
                  ('Insumo Laboratorial',               4,                 1),
                  ('Antiulceroso',                      2,                 1),
                  ('Antiagregante Plaquetário',         2,                 1),
                  ('Anti-inflamatório',                 2,                 1),
                  ('Antiparasitário',                   2,                 1),
                  ('Antissépticos',                     4,                 1),
                  ('Agente Hiperglicemiante',           2,                 1),
                  ('Acessório',                         6,                 0),
                  ('EPI - Reutilizável',                5,                 1),
                  ('Instrumental Cirúrgico',            4,                 1),
                  ('Curativo',                          2,                 0),
                  ('Psiquiátrico',                      2,                 0),
                  ('Insumo de Diagnóstico',             4,                 1),
                  ('Antidepressivo',                    2,                 1),
                  ('Detergentes e Sabões',              5,                 1),
                  ('Analgésico/Opioide',                2,                 0),
                  ('Saneantes/Desinfetantes',           5,                 1),
                  ('Infraestrutura e Apoio',            6,                 1),
                  ('Material de Consumo Estéril',       4,                 1),
                  ('Material de Consumo Descartável',   4,                 1),
                  ('Antidiabético',                     2,                 1),
                  ('Hematológico',                      2,                 0),
                  ('Oftálmico',                         2,                 1),
                  ('Analgésico Opioide',                2,                 1),
                  ('Anticonvulsivante/Sedativo',        2,                 1),
                  ('Higiene Pessoal',                   4,                 1),
                  ('Antisséptico',                      2,                 1),
                  ('Anti-histamínico',                  2,                 1),
                  ('Cicatrizante',                      2,                 1),
                  ('Reposição Hidroeletrolítica',       2,                 0),
                  ('Antiemético',                       2,                 1),
                  ('Cardiovascular',                    2,                 1),
                  ('Material de Esterilização',         4,                 1),
                  ('Antihipertensivo',                  2,                 1),
                  ('Curativos Especiais',               4,                 1),
                  ('Antiagregante',                     2,                 0),
                  ('Instrumental Clínico',              4,                 0),
                  ('Anestésico Local',                  2,                 1),
                  ('Solução Parenteral',                2,                 1),
                  ('Diluente',                          2,                 0),
                  ('Expectorante',                      2,                 1),
                  ('Escrita e Escritório',              6,                 1),
                  ('Vasoprotetor',                      2,                 1),
                  ('Hidratação',                        2,                 1),
                  ('Hotelaria Hospitalar',              4,                 1),
                  ('Equipamento',                       4,                 1),
                  ('EPI',                               4,                 1),
                  ('Suplemento',                        2,                 0),
                  ('Produto Químico',                   5,                 0),
                  ('Antigotoso',                        2,                 1),
                  ('Utensílios de Limpeza',             5,                 1),
                  ('Reumatológico',                     2,                 0),
                  ('Solvente/Veículo',                  2,                 1),
                  ('Ansiolítico/Sedativo',              2,                 1),
                  ('Repositor Hidroeletrolítico',       2,                 1),
                  ('Emergência',                        2,                 1),
                  ('Kit de Procedimento',               4,                 1),
                  ('Vacina',                            2,                 1),
                  ('Vestuário Hospitalar',              4,                 1),
                  ('Anticoncepcional',                  2,                 1),
                  ('Eletrólito',                        2,                 1)
...
;WITH RandomDates (
      ...
      FROM (
         ...
         -- ('Name',                                            'Description',                                                                      MainCategoryId',  'SubCategoryId',  'PackagingTypeId',     'IsActive')
            ...
            ('Amoxicilina 500mg',                               'Antibiótico penicilínico.',                                                        2,                 37,               2,                     1),
            ('Cefalexina 250mg/5mL',                            'Antibiótico cefalosporina.',                                                       2,                 37,               9,                     1),
            ('Omeprazol 20mg',                                  'Inibidor da bomba de prótons.',                                                    2,                 28,               1,                     1),
            ('Loratadina 5mg/5mL',                              'Antialérgico.',                                                                    2,                 8,                11,                    1),
            ('Máscara Proteção N95',                            'Respirador PFF2 tipo N95 para proteção contra aerossóis.',                         4,                 92,               3,                     1),
            ('Losartana Potássica 50mg',                        'Anti-hipertensivo, bloqueador de receptor de angiotensina.',                       2,                 77,               1,                     1),
            ('Cloridrato de Fluoxetina 20mg',                   'Antidepressivo inibidor seletivo da recaptação de serotonina.',                    2,                 59,               1,                     1),
            ('Diazepam 10mg',                                   'Ansiolítico benzodiazepínico.',                                                    2,                 45,               1,                     1),
            ('Insulina NPH',                                    'Insulina basal.',                                                                  2,                 66,               5,                     1),
            ('Hidrocortisona 100mg',                            'Corticoide EV.',                                                                   2,                 33,               5,                     1),
            ('Dipirona Sódica 500mg/ml',                        'Analgésico e Antitérmico intravenoso/intramuscular.',                              2,                 29,               5,                     1),
            ('Cloridrato de Clorpromazina 100mg',               'Antipsicótico típico.',                                                            2,                 1,                1,                     1),
            ('Carbonato de Lítio 300mg',                        'Estabilizador do humor para transtorno bipolar.',                                  2,                 40,               1,                     1),
            ('Butilbrometo de Escopolamina',                    'Antiespasmódico para cólicas.',                                                    2,                 22,               1,                     1),
            ('Adrenalina 1 mg/mL',                              'Catecolamina usada em anafilaxia e parada cardíaca.',                              2,                 101,              5,                     1),
            ('Cloridrato de Lidocaína 2% sem Vasoconstrictor',  'Anestésico local de curta duração, indicado para áreas de extremidades.',          2,                 83,               5,                     1),
            ('Soro Fisiológico 500mL',                          'Solução isotônica.',                                                               2,                 89,               11,                    1),
            ('Água Destilada 10 mL',                            'Veículo estéril para diluição de medicamentos injetáveis.',                        2,                 98,               5,                     1),
            ('Pilha Alcalina AAA (Palito)',                     'Fonte de energia para controles, lanternas e oxímetros.',                          6,                 38,               3,                     1),
            ('Pilha Alcalina AA',                               'Fonte de energia para mouses, termômetros e equipamentos médicos.',                6,                 38,               3,                     1),
            ('Cloridrato de Levomepromazina 25mg',              'Antipsicótico sedativo.',                                                          2,                 1,                1,                     1),
            ('Sulfato Ferroso',                                 'Tratamento de anemia ferropriva.',                                                 2,                 25,               1,                     1),
            ('Cloridrato de Amiodarona 200mg',                  'Antiarrítmico classe III.',                                                        2,                 77,               1,                     1),
            ('Cloridrato de Tramadol 50mg/mL',                  'Analgésico opioide.',                                                              2,                 69,               5,                     1),
            ('Morfina 10mg',                                    'Analgésico opioide potente para dor intensa.',                                     2,                 69,               5,                     1),
            ('Captopril 25mg',                                  'Antihipertensivo inibidor da ECA.',                                                2,                 79,               1,                     1),
            ('Furosemida 40mg',                                 'Diurético de alça.',                                                               2,                 44,               1,                     1),
            ('Cloridrato de Sertralina 50mg',                   'Antidepressivo ISRS.',                                                             2,                 59,               1,                     1),
            ('Lorazepam 2mg',                                   'Ansiolítico, Benzodiazepínico.',                                                   2,                 35,               1,                     0),
            ('Vacina DTPa',                                     'Imunização contra Difteria, Tétano e Coqueluche.',                                 2,                 103,              5,                     1),
            ('Vacina Influenza Tetravalente',                   'Imunização anual contra o vírus da gripe.',                                        2,                 103,              5,                     1),
            ('Cloreto de Benzalcônio',                          'Antisséptico tópico.',                                                             2,                 72,               11,                    1),
            ('Sais de Reidratação Oral',                        'Reposição hidroeletrolítica.',                                                     2,                 89,               15,                    1),
            ('Propranolol 40mg',                                'Betabloqueador.',                                                                  2,                 79,               1,                     1),
            ('AAS 100mg',                                       'Antiagregante plaquetário para prevenção cardiovascular.',                         2,                 77,               1,                     1),
            ('Cinarizina 75mg',                                 'Vasodilatador e antivertiginoso para distúrbios do equilíbrio.',                   2,                 17,               1,                     1),
            ('Cloridrato de Clomipramina 25mg',                 'Antidepressivo tricíclico utilizado também em distúrbios obsessivos.',             2,                 13,               1,                     1),
            ('Cloridrato de Nortriptilina 25mg',                'Antidepressivo tricíclico.',                                                       2,                 13,               1,                     1),
            ('Loratadina 10mg',                                 'Anti-histamínico de segunda geração (não sedante).',                               2,                 73,               1,                     1),
            ('Polivitamínico Baby',                             'Suplemento infantil.',                                                             2,                 34,               11,                    1),
            ('Glicose 25%',                                     'Solução hiperatônica para correção de hipoglicemia.',                              2,                 52,               5,                     1),
            ('Soro Fisiológico 0,9%',                           'Solução para reposição hidroeletrolítica.',                                        2,                 100,              21,                    1),
            ('Óculos de Proteção',                              'Óculos de segurança com proteção lateral e tratamento antiembaçante.',             4,                 92,               3,                     0),
            ('Cloridrato de Amitriptilina 25mg',                'Antidepressivo tricíclico com efeito sedativo.',                                   2,                 13,               1,                     1),
            ('Digoxina 0,25mg',                                 'Glicosídeo cardíaco para tratamento de insuficiência cardíaca e arritmias.',       2,                 20,               1,                     1),
            ('Espironolactona 25mg',                            'Diurético poupador de potássio e anti-hipertensivo.',                              2,                 44,               1,                     1),
            ('Clonazepam 2mg',                                  'Benzodiazepínico ansiolítico e anticonvulsivante.',                                2,                 45,               1,                     1),
            ('Cloridrato de Levomepromazina 100mg',             'Antipsicótico sedativo.',                                                          2,                 1,                1,                     1),
            ('Fenobarbital 40mg/mL',                            'Anticonvulsivante.',                                                               2,                 16,               11,                    1),
            ('Metronidazol 250mg',                              'Antiprotozoário e antibacteriano anaeróbio.',                                      2,                 37,               1,                     1),
            ('Fluconazol 150mg',                                'Antifúngico oral de dose única.',                                                  2,                 18,               2,                     0),
            ('Cefalexina 500mg',                                'Antibiótico cefalosporina.',                                                       2,                 37,               2,                     1),
            ('Levotiroxina Sódica 100mcg',                      'Hormônio tireoidiano.',                                                            2,                 10,               1,                     1),
            ('Glicose 50%',                                     'Solução hiperatônica para correção rápida de hipoglicemia grave.',                 2,                 52,               5,                     1),
            ('Cloridrato de Prometazina 25mg',                  'Anti-histamínico com ação antiemética e sedativa.',                                2,                 73,               1,                     1),
            ('Dramin B6 DL EV 10mL',                            'Antiemético.',                                                                     2,                 76,               5,                     1),
            ('Dersani',                                         'Óleo à base de AGE para cicatrização e proteção dérmica.',                         2,                 74,               11,                    1),
            ('Varfarina 5mg',                                   'Anticoagulante oral.',                                                             2,                 21,               1,                     1),
            ('Dipirona Gotas 500mg/ml',                         'Analgésico e Antitérmico.',                                                        2,                 29,               11,                    1),
            ('Paracetamol Gotas 200mg/mL',                      'Analgésico e Antitérmico.',                                                        2,                 29,               11,                    1),
            ('Metildopa 250mg',                                 'Antihipertensivo seguro na gestação.',                                             2,                 79,               1,                     1),
            ('Lâmina Bisturi Nº15',                             'Lâmina cirúrgica descartável para procedimentos delicados',                        4,                 65,               3,                     1),
            ('Lâmina Bisturi Nº23',                             'Lâmina cirúrgica descartável para incisões extensas.',                             4,                 65,               3,                     1),
            ('Nitroglicerina 5mg/mL',                           'Vasodilatador para emergências.',                                                  2,                 77,               5,                     1),
            ('Alopurinol 300mg',                                'Inibidor da síntese de ácido úrico.',                                              2,                 95,               1,                     0),
            ('Nitrazepam 5mg',                                  'Hipnótico benzodiazepínico.',                                                      2,                 99,               1,                     1),
            ('Prednisona 20mg',                                 'Corticoide sistêmico.',                                                            2,                 33,               1,                     1),
            ('Fentanil 50mcg/ml',                               'Analgésico opioide de curta duração e alta potência.',                             2,                 69,               5,                     0),
            ('Biperideno 2mg',                                  'Anticolinérgico para controle de efeitos extrapiramidais.',                        2,                 6,                1,                     1),
            ('Haloperidol 2mg/mL',                              'Antipsicótico típico.',                                                            2,                 1,                5,                     1),
            ('Agulha Descartável 25 x 7',                       'Agulha hipodérmica para aplicações intramusculares.',                              4,                 65,               8,                     1),
            ('Agulha Descartável 25 x 8',                       'Agulha para aplicações intramusculares.',                                          4,                 65,               8,                     1),
            ('Agulha 32G x 4mm',                                'Agulha ultrafina para aplicações subcutâneas.',                                    4,                 65,               7,                     1),
            ('Haloperidol 5mg',                                 'Antipsicótico típico.',                                                            2,                 1,                1,                     1),
            ('Bromoprida 4mg/mL',                               'Antiemético e pró-cinético.',                                                      2,                 76,               11,                    1),
            ('Dexclorfeniramina 2mg',                           'Anti-histamínico clássico para processos alérgicos.',                              2,                 73,               1,                     1),
            ('Levonorgestrel 0,75mg',                           'Contraceptivo de emergência.',                                                     2,                 105,              1,                     1),
            ('Carbonato de Cálcio 500mg',                       'Suplemento mineral para reposição de cálcio.',                                     2,                 25,               1,                     1),
            ('Bromoprida 5mg',                                  'Antiemético e pró-cinético.',                                                      2,                 76,               5,                     1),
            ('Ceftriaxona 1g',                                  'Antibiótico de amplo espectro.',                                                   2,                 37,               11,                    1),
            ('Sulfato de Magnésio 10%',                         'Eletrólito utilizado na prevenção de crises convulsivas na eclampsia.',            2,                 9,                5,                     1),
            ('Sabão Líquido Neutro 5L',                         'Sabão para higiene das mãos e limpeza de superfícies delicadas.',                  5,                 11,               6,                     1),
            ('Desengordurante Industrial 5L',                   'Desengordurante alcalino para áreas de cozinha e lavanderia.',                     5,                 60,               6,                     1),
            ('Alvejante sem Cloro 5L',                          'Alvejante à base de peróxido para lavanderia hospitalar.',                         5,                 62,               6,                     1),
            ('Cloridrato de Imipramina 25mg',                   'Antidepressivo tricíclico.',                                                       2,                 59,               1,                     1),
            ('Clopidogrel 75mg',                                'Antiagregante plaquetário para prevenção de eventos aterotrombóticos.',            2,                 48,               1,                     1),
            ('Atenolol 50mg',                                   'Betabloqueador seletivo.',                                                         2,                 77,               1,                     1),
            ('Anlodipino 5mg',                                  'Anti-hipertensivo bloqueador de canais de cálcio.',                                2,                 79,               1,                     1),
            ('Diltiazem 60mg',                                  'Bloqueador de canal de cálcio.',                                                   2,                 79,               1,                     1),
            ('Insulina Regular',                                'Insulina de ação rápida.',                                                         2,                 66,               5,                     1),
            ('Noretisterona 0,35mg',                            'Contraceptivo progesterona isolada.',                                              2,                 105,              1,                     1),
            ('Seringa 5ml',                                     'Seringa para administração de medicamentos.',                                      4,                 65,               3,                     1),
            ('Seringa 10ml',                                    'Seringa descartável com bico Luer Lock ou Luer Slip.',                             4,                 65,               3,                     1),
            ('Ácido Fólico 5mg',                                'Vitamina do complexo B usada na prevenção de anemia megaloblástica.',              2,                 34,               1,                     1),
            ('Cloridrato de Levomepromazina 40mg/mL',           'Antipsicótico.',                                                                   2,                 1,                11,                    1),
            ('Dexametasona Creme',                              'Corticoide tópico.',                                                               2,                 33,               18,                    1),
            ('Benzilpenicilina 1.200.000 UI',                   'Antibiótico penicilínico de ação prolongada.',                                     2,                 37,               5,                     1),
            ('Cloreto de Suxametônio 100mg',                    'Bloqueador neuromuscular de ação rápida.',                                         2,                 26,               5,                     1),
            ('Dexclorfeniramina 2mg/5ml',                       'Antialérgico infantil.',                                                           2,                 8,                11,                    1),
            ('Hidróxido de Alumínio',                           'Antiácido.',                                                                       2,                 28,               9,                     1),
            ('Tiamina (B1)',                                    'Vitamina usada em deficiências e alcoolismo.',                                     2,                 34,               1,                     1),
            ('Fluoresceína 1% Colírio',                         'Corante para exames oftálmicos.',                                                  2,                 68,               11,                    1),
            ('Hipoclorito de Sódio 1% 5L',                      'Solução clorada para limpeza e desinfecção de áreas críticas.',                    5,                 62,               6,                     1),
            ('Cloreto de Sódio 0,9% 10 mL',                     'Diluente e solução fisiológica.',                                                  2,                 100,              5,                     1),
            ('Bicarbonato de Sódio 8,4% 10 mL',                 'Agente alcalinizante para correção de acidose.',                                   2,                 106,              5,                     1),
            ('Dopamina 50mg/ml',                                'Para choque cardiogênico.',                                                        2,                 101,              5,                     1),
            ('Ciprofloxacino 500mg',                            'Antibiótico quinolona.',                                                           2,                 37,               1,                     1),
            ('Carbamazepina 20mg/mL',                           'Anticonvulsivante em solução oral.',                                               2,                 16,               9,                     1),
            ('Soro Fisiológico 1000mL',                         'Solução isotônica.',                                                               2,                 89,               21,                    1),
            ('Complexo B',                                      'Mistura de vitaminas hidrossolúveis do complexo B.',                               2,                 34,               1,                     1),
            ('Cetoprofeno 50mg/mL',                             'Antiinflamatório não esteroidal.',                                                 2,                 4,                5,                     1),
            ('Touca com Elástico',                              'Touca descartável em TNT para procedimentos.',                                     4,                 24,               10,                    1),
            ('Propé Descartável',                               'Cobertura descartável para calçados.',                                             4,                 24,               14,                    0),
            ('Prednisona 5mg',                                  'Corticoide sistêmico.',                                                            2,                 33,               1,                     1),
            ('Dexametasona 2mg/mL',                             'Corticoide sistêmico.',                                                            2,                 33,               5,                     1),
            ('Fenitoína 100mg',                                 'Anticonvulsivante.',                                                               2,                 16,               1,                     1),
            ('Diclofenaco Sódico 50mg',                         'AINE para dor e inflamação.',                                                      2,                 4,                1,                     1),
            ('Nimesulida 50mg/mL',                              'AINE para dor e inflamação.',                                                      2,                 4,                9,                     1),
            ('Nifedipina 20mg',                                 'Vasodilatador para hipertensão e angina.',                                         2,                 79,               1,                     1),
            ('Carbamazepina 200mg',                             'Anticonvulsivante e estabilizador do humor.',                                      2,                 16,               1,                     1),
            ('Glicazida 30mg',                                  'Antidiabético sulfonilureia.',                                                     2,                 66,               1,                     1),
            ('Periciazina 10mg',                                'Antipsicótico.',                                                                   2,                 1,                1,                     1),
            ('Nitrato de Miconazol 20mg/g',                     'Antifúngico.',                                                                     2,                 18,               18,                    1),
            ('Levofloxacino 500mg',                             'Antibiótico quinolona.',                                                           2,                 37,               1,                     1),
            ('Sulfadiazina de Prata 1%',                        'Agente antimicrobiano e cicatrizante tópico.',                                     2,                 74,               18,                    1),
            ('Fita Adesiva Transparente (Durex Grande)',        'Fita multiuso para fechamento de pacotes e reparos rápidos.',                      6,                 63,               23,                    1),
            ('Vitaminas + Sais Minerais',                       'Suplemento polivitamínico.',                                                       2,                 34,               1,                     1),
            ('Carvedilol 6,25mg',                               'Betabloqueador antihipertensivo.',                                                 2,                 79,               1,                     1),
            ('Cimetidina 150mg/mL',                             'Antagonista H2 para gastrite e refluxo.',                                          2,                 28,               5,                     1),
            ('Ambroxol 15mg/mL',                                'Mucolítico usado para secreções respiratórias.',                                   2,                 86,               11,                    1),
            ('Citrato de Fentanila 0,05 mg/mL',                 'Opioide para analgesia e sedação.',                                                2,                 69,               5,                     1),
            ('Extensão Elétrica (3 Metros)',                    'Acessório para ampliação do alcance de tomadas em consultórios.',                  6,                 63,               3,                     1),
            ('Aciclovir 200mg',                                 'Antiviral para herpes simples e zoster.',                                          2,                 36,               1,                     1),
            ('Gluconato de Cálcio 10%',                         'Reposição de cálcio intravenoso.',                                                 2,                 106,              5,                     1),
            ('Cimetidina 200mg',                                'Antagonista dos receptores H2 para redução da acidez gástrica.',                   2,                 47,               1,                     1),
            ('Levonorgestrel 0,15 + Etinilestradiol 0,03',      'Contraceptivo hormonal combinado.',                                                2,                 105,              1,                     1),
            ('Ácido Valproico 250mg',                           'Antiepiléptico e estabilizador do humor.',                                         2,                 16,               1,                     1),
            ('Tioridazina 100mg',                               'Antipsicótico.',                                                                   2,                 1,                1,                     1),
            ('Fita Teste de Glicemia',                          'Tiras reagentes para monitorização de glicose capilar.',                           4,                 58,               11,                    1),
            ('Bicarbonato de Sódio 8,4% 250 mL',                'Corretor de acidose metabólica.',                                                  2,                 101,              11,                    1),
            ('Luva Látex Procedimento P',                       'Luva de látex não estéril para exames e proteção.',                                4,                 24,               8,                     1),
            ('Luva Látex Procedimento M',                       'Luva de látex não estéril para exames e proteção.',                                4,                 24,               8,                     1),
            ('Luva Látex Procedimento G',                       'Luva de látex não estéril para exames e proteção.',                                4,                 24,               8,                     1),
            ('Sonda Aspiração Traqueal c/ V Nº12',              'Sonda com válvula para aspiração de secreções.',                                   4,                 65,               3,                     1),
            ('Luva Estéril Nº7,5',                              'Luva cirúrgica de látex, estéril e lubrificada, cano longo.',                      4,                 64,               8,                     1),
            ('Luva Estéril Nº8,0',                              'Luva cirúrgica de látex, estéril e lubrificada, cano longo.',                      4,                 64,               8,                     1),
            ('Máscara Hudson com Reservatório Adulto',          'Máscara facial para oxigenoterapia de alta concentração com bolsa reservatório.',  4,                 65,               3,                     1),
            ('Máscara N95 PFF2',                                'Alta filtração, para aerossóis.',                                                  4,                 24,               3,                     0),
            ('Sonda Foley 2 Vias Nº14',                         'Sonda uretral em látex com balão para drenagem urinária de demora.',               4,                 64,               3,                     1),
            ('Avental Camisola Hospitalar Tamanho M',           'Camisola hospitalar para paciente em algodão ou misto.',                           4,                 104,              3,                     1),
            ('Avental Camisola Hospitalar Tamanho P',           'Camisola hospitalar para paciente em algodão ou misto.',                           4,                 104,              3,                     1),
            ('Lápis Preto número 2',                            'Para rascunhos.',                                                                  6,                 87,               13,                    0),
            ('Protetor Facial Face Shield',                     'Protetor facial completo em policarbonato, reutilizável.',                         4,                 92,               3,                     1),
            ('Seringa 3ml',                                     'Seringa para aplicações gerais.',                                                  4,                 65,               3,                     1),
            ('Seringa Insulina 1ml',                            'Seringa descartável com agulha fixa graduada em 100 UI.',                          4,                 65,               3,                     1),
            ('Agulha Descartável 30 x 8',                       'Agulha hipodérmica de uso geral.',                                                 4,                 65,               7,                     1),
            ('Agulha Descartável 30 x 7',                       'Agulha para aplicações subcutâneas ou intradérmicas.',                             4,                 65,               7,                     1),
            ('Scalp 23',                                        'Scalp para punção em veias delicadas.',                                            4,                 65,               3,                     1),
            ('Sonda Foley 2 Vias Nº16',                         'Sonda uretral em látex com balão para drenagem urinária de demora.',               4,                 64,               3,                     1),
            ('Abaixador de Língua - Espátula de Madeira',       'Espátula descartável para exame orofaríngeo.',                                     4,                 65,               10,                    1),
            ('Compressa de Gaze Estéril',                       'Gaze hidrófila estéril para curativos e assepsia.',                                4,                 65,               10,                    1),
            ('Compressa de Gaze Não Estéril',                   'Gaze não estéril para limpeza.',                                                   4,                 65,               10,                    1),
            ('Algodão Hidrófilo Rolo 500g',                     'Algodão para curativos e higienização.',                                           4,                 65,               23,                    1),
            ('Caneta Esferográfica',                            'Para uso diário, escrita de prontuários.',                                         6,                 27,               24,                    0),
            ('Atadura de Crepe 10cm',                           'Faixa de crepe para enfaixamento e compressão.',                                   4,                 65,               23,                    1),
            ('Esparadrapo Médio',                               'Fita adesiva de alta adesão para fixação de curativos.',                           4,                 65,               23,                    1),
            ('Fita Micropore 50x10',                            'Fita microporosa hipoalergênica.',                                                 4,                 65,               23,                    1),
            ('Lençol de Papel Descartável',                     'Rolo de lençol de papel para cobertura de macas.',                                 4,                 39,               23,                    1),
            ('Envelope Branco para Exames (260x360mm)',         'Envelope para acondicionamento e entrega de exames de imagem.',                    6,                 7,                4,                     1),
            ('Gel para ECG e Ultrassom 100g',                   'Gel condutor hipoalergênico e solúvel em água.',                                   4,                 58,               11,                    1),
            ('Papel Sulfite A4',                                'Para impressão de laudos, receitas e prontuários.',                                6,                 7,                8,                     0),
            ('Eletrodos Descartáveis para ECG',                 'Eletrodo autoadesivo com gel sólido para monitorização.',                          4,                 58,               17,                    1),
            ('Papel Térmico ECG 210mm x 30m',                   'Papel termossensível para registro de eletrocardiograma.',                         4,                 58,               23,                    1),
            ('Tesoura Mayo 17cm',                               'Tesoura cirúrgica para tecidos.',                                                  4,                 55,               3,                     1),
            ('Seringa 1ml sem Agulha',                          'Seringa de precisão para pequenas doses.',                                         4,                 65,               3,                     1),
            ('Sonda Retal Nº04',                                'Sonda flexível para administração retal.',                                         4,                 65,               3,                     0),
            ('Abocath Nº22 com Dispositivo de Segurança',       'Cateter intravenoso periférico com dispositivo de segurança.',                     4,                 65,               3,                     1),
            ('Agulha Descartável 13 x 4,5',                     'Agulha hipodérmica para administração de medicamentos.',                           4,                 65,               7,                     1),
            ('Oxímetro de Pulso de Dedo',                       'Dispositivo portátil para monitorização da SpO2 e pulso.',                         4,                 91,               3,                     0),
            ('Clorexidina Hidroalcoólica 0,5%',                 'Antisséptico alcoólico para higienização das mãos.',                               5,                 11,               11,                    1),
            ('Seringa 20ml',                                    'Seringa de grande volume.',                                                        4,                 65,               3,                     1),
            ('Sonda Uretral Nº20',                              'Sonda uretral de grande calibre.',                                                 4,                 65,               3,                     1),
            ('Tala Aramada Revestida G',                        'Tala em aramado maleável revestida com espuma para imobilização provisória.',      4,                 65,               3,                     1),
            ('Termômetro Digital',                              'Termômetro clínico para medição de temperatura corporal.',                         4,                 91,               3,                     1),
            ('Termômetro Infravermelho',                        'Termômetro digital clínico com sensor infravermelho sem contato.',                 4,                 14,               3,                     1),
            ('Pano de Microfibra Verde',                        'Pano de alta absorção para áreas de manipulação de alimentos.',                    5,                 96,               3,                     1),
            ('Receituário Médico Padrão (Bloco)',               'Bloco para prescrição médica simples (não controlada).',                           6,                 7,                16,                    1),
            ('Desinfetante para Superfícies 5L',                'Desinfetante hospitalar de nível intermediário para superfícies fixas.',           5,                 62,               6,                     1),
            ('Álcool Etílico 70% Líquido 1L',                   'Desinfetante e antisséptico para superfícies e mãos.',                             5,                 62,               11,                    1),
            ('Desincrustante Ácido 5L',                         'Detergente ácido para remoção de incrustações em pisos e pedras.',                 5,                 60,               6,                     1),
            ('Detergente Enzimático 5L',                        'Detergente com enzimas para remoção de matéria orgânica.',                         5,                 60,               6,                     1),
            ('Avental Camisola Hospitalar Tamanho G',           'Camisola hospitalar para pacientes.',                                              4,                 104,              3,                     1),
            ('Pano de Microfibra Azul',                         'Pano de alta absorção para limpeza geral de mobiliário.',                          5,                 96,               3,                     1),
            ('Pano de Microfibra Vermelho',                     'Pano de alta absorção para áreas de alto risco (sanitários).',                     5,                 96,               3,                     1),
            ('Papel Sulfite A4 75g',                            'Papel para impressão de laudos, receitas e prontuários.',                          6,                 7,                8,                     1),
            ('Mop Flat',                                        'Equipamento para aplicação de desinfetante e limpeza úmida.',                      5,                 96,               3,                     1),
            ('Detergente Enzimático',                           'Detergente com enzimas.',                                                          5,                 60,               6,                     0),
            ('Placa de Sinalização "Piso Molhado"',             'Item de segurança para sinalização de perigo em áreas úmidas.',                    5,                 96,               3,                     1),
            ('Lixeira com Pedal 50L',                           'Recipiente para descarte de resíduos com acionamento por pedal.',                  5,                 96,               3,                     1),
            ('Papel Toalha Interfolhado',                       'Papel toalha folha dupla para secagem das mãos.',                                  5,                 11,               12,                    1),
            ('Dispenser de Papel Toalha',                       'Suporte de parede para acondicionamento de papel toalha.',                         5,                 96,               3,                     1),
            ('Sabonete Líquido Neutro 5L',                      'Sabonete para higienização e antissepsia básica das mãos.',                        5,                 11,               6,                     1),
            ('Dispenser de Sabonete Líquido',                   'Suporte para sabonete líquido ou álcool em gel.',                                  5,                 96,               3,                     1),
            ('Papel Higiênico Rolão 300m',                      'Papel higiênico para dispensers em áreas de alto fluxo.',                          5,                 11,               12,                    1),
            ('Saco Plástico Hospitalar 100L',                   'Saco de lixo para resíduos hospitalares.',                                         5,                 2,                10,                    1),
            ('Saco de Lixo Branco Hospitalar 50L',              'Saco plástico para resíduos infectantes de médio porte.',                          5,                 2,                10,                    1),
            ('Sonda Retal Nº14',                                'Sonda retal de grande calibre.',                                                   4,                 65,               3,                     1),
            ('Caneta Esferográfica (Azul)',                     'Escrita diária e preenchimento de prontuários.',                                   6,                 87,               24,                    1),
            ('Caneta Esferográfica (Vermelha)',                 'Escrita diária e assinaturas oficiais.',                                           6,                 87,               24,                    1),
            ('Caneta Esferográfica (Preta)',                    'Destaque e correções em documentos administrativos.',                              6,                 87,               24,                    1),
            ('Lápis Preto Nº 2',                                'Grafite para rascunhos e anotações temporárias.',                                  6,                 87,               13,                    1),
            ('Borracha Branca',                                 'Correção de escrita a lápis.',                                                     6,                 87,               3,                     1),
            ('Grampeador de Mesa',                              'Equipamento para união de documentos.',                                            6,                 87,               3,                     1),
            ('Grampos 26/6 Galvanizados',                       'Suprimento para grampeador de mesa.',                                              6,                 87,               22,                    1),
            ('Clipes para Papel Nº 3/0',                        'Organização de pequenos volumes de documentos.',                                   6,                 87,               7,                     1),
            ('Envelope Pardo Ofício',                           'Envelope para transporte e envio de documentos administrativos.',                  6,                 7,                14,                    1),
            ('Toner para Impressora Laser',                     'Insumo de tinta em pó para impressão de documentos.',                              6,                 38,               3,                     0),
            ('Cartucho de Tinta Preto',                         'Insumo de tinta líquida para impressoras jato de tinta.',                          6,                 38,               3,                     0),
            ('Paracetamol 500mg',                               'Analgésico e Antitérmico.',                                                        2,                 29,               1,                     1),
            ('Ibuprofeno 400mg',                                'Anti-inflamatório não esteroidal (AINE).',                                         2,                 4,                2,                     1),
            ('Amoxicilina 250mg/5mL',                           'Antibiótico penicilínico.',                                                        2,                 37,               9,                     1),
            ('Omeprazol 40mg',                                  'Inibidor de bomba de prótons.',                                                    2,                 28,               2,                     1),
            ('Sinvastatina 20mg',                               'Hipolipemiante, controle de colesterol.',                                          2,                 77,               1,                     0),
            ('Losartana Potássica 25mg',                        'Anti-hipertensivo.',                                                               2,                 77,               1,                     1),
            ('Cloridrato de Fluoxetina 10mg',                   'Antidepressivo, dose inicial.',                                                    2,                 35,               2,                     1),
            ('Diazepam 10mg/2mL',                               'Benzodiazepínico para sedação e controle de convulsões.',                          2,                 70,               5,                     1),
            ('Luva de Borracha Tamanho G',                      'Luva de proteção para manuseio de químicos e umidade.',                            5,                 54,               3,                     1),
            ('Hidrocortisona 500mg',                            'Corticoide EV.',                                                                   2,                 33,               5,                     0),
            ('Gel para Ultrassom 300g',                         'Gel condutor hipoalergênico para exames de imagem e Doppler.',                     4,                 58,               11,                    1),
            ('Pera para ECG',                                   'Pêra de borracha reutilizável para ventosa de ECG.',                               4,                 3,                3,                     1),
            ('Pilha Alcalina D (Grande)',                       'Fonte de energia para equipamentos de grande porte.',                              6,                 38,               3,                     1),
            ('Cimetidina 300mg/2mL',                            'Antagonista H2.',                                                                  2,                 28,               5,                     1),
            ('Azitromicina 250mg',                              'Antibiótico Macrolídeo.',                                                          2,                 37,               1,                     1),
            ('Cloridrato de Lidocaína 2% com Vasoconstrictor',  'Anestésico local de duração prolongada, promove controle de sangramento local.',   2,                 83,               5,                     1),
            ('Soro Fisiológico 100mL',                          'Solução isotônica.',                                                               2,                 89,               11,                    1),
            ('Soro Glicosado 5%',                               'Solução para hidratação.',                                                         2,                 84,               21,                    1),
            ('Cumarina + Troxirrutina',                         'Flebotônico para varizes.',                                                        2,                 88,               1,                     1),
            ('Captopril 50mg',                                  'Anti-hipertensivo, Inibidor da ECA.',                                              2,                 77,               1,                     0),
            ('Furosemida 10mg/mL',                              'Diurético de alça.',                                                               2,                 44,               5,                     1),
            ('Sertralina 100mg',                                'Antidepressivo ISRS.',                                                             2,                 35,               1,                     0),
            ('Lorazepam 1mg',                                   'Ansiolítico, Benzodiazepínico.',                                                   2,                 35,               1,                     1),
            ('Propranolol 80mg',                                'Betabloqueador.',                                                                  2,                 77,               1,                     0),
            ('Pilha AA',                                        'Pilha para equipamentos médicos.',                                                 6,                 38,               20,                    0),
            ('Pilha AAA',                                       'Pilha para dispositivos clínicos.',                                                6,                 38,               20,                    0),
            ('Dipirona Sódica 1g/2ml',                          'Analgésico e Antitérmico intravenoso/intramuscular.',                              2,                 29,               5,                     1),
            ('Isossorbida 10mg',                                'Vasodilatador para angina.',                                                       2,                 77,               1,                     1),
            ('Complexo B Injetável',                            'Reposição de vitaminas B.',                                                        2,                 34,               5,                     1),
            ('Clonazepam Gotas',                                'Anticonvulsivante e ansiolítico.',                                                 2,                 35,               11,                    1),
            ('Metronidazol 40mg/mL',                            'Antiprotozoário.',                                                                 2,                 37,               9,                     1),
            ('Flumazenil Solução Injetável',                    'Antagonista Benzodiazepínico.',                                                    2,                 101,              5,                     1),
            ('Albendazol 400mg',                                'Antiparasitário de amplo espectro.',                                               2,                 50,               1,                     1),
            ('Varfarina Sódica 2.5mg',                          'Anticoagulante oral.',                                                             2,                 21,               1,                     1),
            ('Tubo Endotraqueal 8,0',                           'Tubo com cuff para intubação orotraqueal em adultos.',                             4,                 64,               3,                     1),
            ('Hipoclorito 2,5% 5L',                             'Desinfetante clorado para superfícies e áreas sanitárias.',                        5,                 62,               6,                     0),
            ('Detergente Neutro para Louças 5L',                'Detergente de uso geral para limpeza de utensílios e superfícies.',                5,                 60,               6,                     1),
            ('Luva de Borracha Tamanho M',                      'Luva de proteção para manuseio de químicos e umidade.',                            5,                 54,               3,                     1),
            ('Saco de Lixo Cinza 40L',                          'Saco plástico para resíduos comuns não recicláveis.',                              5,                 2,                10,                    1),
            ('Catgut 3.0 com Agulha',                           'Fio cirúrgico absorvível de origem animal para suturas internas.',                 4,                 64,               25,                    1),
            ('Catgut 4.0 com Agulha',                           'Fio absorvível para suturas delicadas.',                                           4,                 64,               25,                    1),
            ('Sonda Aspiração Traqueal c/ V Nº6',               'Sonda flexível para aspiração de vias aéreas.',                                    4,                 65,               3,                     1),
            ('Sonda Foley 2 Vias Nº20',                         'Sonda para drenagem urinária.',                                                    4,                 65,               3,                     0),
            ('Clorexidina Aquosa 1% 1L',                        'Antisséptico tópico para desinfecção de pele.',                                    4,                 51,               11,                    1),
            ('Clorexidina Degermante 2% 1L',                    'Antisséptico com detergente para degermação das mãos.',                            4,                 51,               11,                    1),
            ('Esparadrapo 10cm',                                'Fita adesiva para fixação de curativos.',                                          4,                 65,               23,                    1),
            ('Nebulizador',                                     'Aparelho compressor para administração de aerossóis.',                             4,                 91,               3,                     0),
            ('Flanela Laranja',                                 'Pano de algodão para polimento e limpeza a seco de móveis.',                       5,                 96,               3,                     1),
            ('Sabonete Neutro',                                 'Sabonete em barra ou líquido para higiene corporal.',                              5,                 11,               3,                     1),
            ('Abocath Nº18',                                    'Cateter intravenoso periférico para punção venosa.',                               4,                 65,               3,                     1),
            ('Oxímetro de Pulso Infantil Display LED',          'Oxímetro portátil para monitoração de saturação.',                                 4,                 91,               3,                     1),
            ('Aparelho de Glicemia',                            'Glicosímetro portátil para leitura de fitas reagentes.',                           4,                 91,               3,                     1),
            ('Agulha Descartável 40 x 12',                      'Agulha para aplicações intramusculares profundas.',                                4,                 65,               7,                     1),
            ('Agulha para Caneta de Insulina 4mm',              'Agulha ultracurta para aplicação de insulina.',                                    4,                 65,               7,                     1),
            ('Luva Estéril Nº8,5',                              'Luva cirúrgica estéril tamanho 8,5.',                                              4,                 24,               8,                     1),
            ('Otoscópio',                                       'Equipamento para inspeção do ouvido.',                                             4,                 91,               3,                     1),
            ('Nebulizador tipo Copinho',                        'Kit de micronebulização (copo, máscara e extensão) para rede de gases.',           4,                 65,               3,                     0),
            ('Máscara Respiratória PFF2 Sem Válvula',           'Respirador descartável de proteção respiratória.',                                 4,                 24,               3,                     1),
            ('Sonda Nasogástrica Longa Nº14',                   'Sonda para drenagem e descompressão.',                                             4,                 65,               3,                     1),
            ('Tubo Cirúrgico Silicone',                         'Tubo cirúrgico estéril de silicone.',                                              4,                 65,               3,                     1),
            ('Sapatilha Cirúrgica Estéril (Propé)',             'Para centro cirúrgico.',                                                           4,                 24,               26,                    1),
            ('Luva Nitrílica Procedimento G',                   'Luva nitrílica livre de látex para procedimentos clínicos.',                       4,                 24,               8,                     1),
            ('Espátula de Ayres c/ 100',                        'Espátula para coleta citológica.',                                                 4,                 65,               14,                    1),
            ('Espéculo Descartável G',                          'Espéculo ginecológico tamanho G.',                                                 4,                 65,               3,                     1),
            ('Atadura de Crepe 15cm',                           'Faixa de crepe para enfaixamento de áreas maiores.',                               4,                 65,               23,                    1),
            ('Pano de Chão Grosso',                             'Pano de algodão de alta gramatura para limpeza de pisos.',                         5,                 96,               3,                     1),
            ('Vassoura de Piaçava',                             'Utensílio para varredura de áreas internas e externas.',                           5,                 96,               3,                     0),
            ('Pá de Lixo com Cabo',                             'Acessório para coleta de resíduos e detritos do solo.',                            5,                 96,               3,                     0),
            ('Álcool em Gel 70% 5L',                            'Higienizador de mãos com propriedades antissépticas.',                             5,                 11,               6,                     1),
            ('Avental Impermeável de PVC',                      'EPI para proteção do tronco contra umidade e respingos.',                          5,                 54,               3,                     1),
            ('Formulário de Relatório de Enfermagem (Bloco)',   'Bloco padronizado para registro de passagem de plantão.',                          6,                 7,                16,                    1),
            ('Porta Canetas de Mesa (Acrílico)',                'Organizador de mesa para materiais de escrita.',                                   6,                 87,               3,                     1),
            ('Tesoura de Escritório Grande',                    'Corte de papel, fitas e embalagens plásticas.',                                    6,                 87,               3,                     1),
            ('Fita Dupla Face',                                 'Fixação de avisos, cartazes e sinalizações em paredes.',                           6,                 63,               23,                    1),
            ('Alvejante Clorado 5L',                            'Agente para remoção de manchas pigmentares e desinfecção.',                        5,                 62,               6,                     1),
            ('Bolsa Coletora de Urina Sistema Fechado',         'Sistema fechado para drenagem urinária.',                                          4,                 65,               3,                     1),
            ('Lâmina Bisturi Nº11',                             'Lâmina cirúrgica descartável com ponta aguda para incisões de punção.',            4,                 65,               3,                     1),
            ('Bota de Unna',                                    'Bandagem impregnada com óxido de zinco para terapia compressiva.',                 4,                 80,               3,                     1),
            ('Kit Papanicolau Tamanho P',                       'Kit ginecológico para coleta citopatológica.',                                     4,                 65,               3,                     1),
            ('Kit Sondagem Vesical Estéril',                    'Conjunto completo de itens para cateterismo urinário estéril.',                    4,                 102,              3,                     1),
            ('Solução Degermante PVPI 10% 1L',                  'Antisséptico para assepsia.',                                                      2,                 30,               11,                    1),
            ('Abocath Nº18 com Dispositivo de Segurança',       'Cateter intravenoso com sistema de segurança.',                                    4,                 65,               3,                     1),
            ('Sonda Nasogástrica Longa Nº06',                   'Sonda para drenagem e aspiração gástrica.',                                        4,                 65,               3,                     1),
            ('Luva Estéril Nº7,0',                              'Luva cirúrgica estéril tamanho 7,0.',                                              4,                 24,               8,                     1),
            ('Sonda Nasogástrica Longa Nº16',                   'Sonda de médio calibre para drenagem gástrica.',                                   4,                 65,               3,                     1),
            ('Saco para Lixo Hospitalar Vermelho 100L',         'Saco para resíduos perigosos de risco biológico específico.',                      5,                 2,                10,                    1),
            ('Descarpak 7 Litros',                              'Coletor rígido para perfurocortantes 7L.',                                         4,                 65,               3,                     1),
            ('Curativo Antimicrobiano 3 Camadas',               'Curativo especial com ação antimicrobiana.',                                       4,                 65,               3,                     1),
            ('Coletor Descartável Perfurocortante 3L',          'Coletor rígido para descarte de perfurocortantes.',                                4,                 65,               3,                     0),
            ('Teste de Gravidez Tira',                          'Teste rápido de gravidez.',                                                        4,                 65,               3,                     1),
            ('Luva Vinil Procedimento G',                       'Luva de vinil para procedimentos de baixa complexidade.',                          4,                 24,               8,                     1),
            ('Toalha de Banho',                                 'Toalha em algodão para higiene de pacientes.',                                     4,                 90,               3,                     1),
            ('Jaleco de TNT Descartável',                       'Barreira de proteção para visitantes e profissionais.',                            4,                 24,               3,                     1),
            ('Abocath Nº16',                                    'Cateter intravenoso periférico para punção venosa.',                               4,                 65,               3,                     1),
            ('Sonda Foley Nº18 3 Vias',                         'Sonda tripla para irrigação e drenagem urinária.',                                 4,                 65,               3,                     1),
            ('Sabão em Pó Industrial 25kg',                     'Detergente em pó de alta performance para lavanderia e pisos.',                    5,                 60,               3,                     1),
            ('Calçados de Segurança Antiderrapantes',           'EPI para proteção de membros inferiores contra umidade e quedas.',                 5,                 54,               3,                     1),
            ('Botas de Borracha',                               'Calçado de cano longo para proteção em áreas úmidas.',                             5,                 54,               3,                     1),
            ('Pasta Arquivo Morto (Papelão)',                   'Arquivamento e organização de prontuários e documentos inativos.',                 6,                 7,                19,                    1),
            ('Sonda Aspiração Traqueal c/ V Nº14',              'Sonda para aspiração profunda.',                                                   4,                 65,               3,                     1),
            ('Sonda Nasoenteral 12Fr',                          'Sonda flexível para nutrição enteral.',                                            4,                 65,               3,                     1),
            ('Luva Estéril Nº6,5',                              'Luva cirúrgica estéril tamanho 6,5.',                                              4,                 24,               8,                     1),
            ('Cateter de Oxigênio Adulto Tipo Óculos',          'Cateter nasal para oxigenoterapia.',                                               4,                 65,               3,                     1),
            ('Cânula de Guedel Nº3',                            'Cânula orofaríngea para manutenção da via aérea.',                                 4,                 65,               3,                     1),
            ('Detergente Desincrustante Ácido 5L',              'Detergente para limpeza pesada de incrustações minerais.',                         5,                 60,               6,                     1),
            ('Limpa Vidros Concentrado 5L',                     'Produto químico específico para limpeza de vidros e espelhos.',                    5,                 60,               6,                     1),
            ('Lâmina para Microscopia',                         'Lâmina de vidro para análise de amostras laboratoriais.',                          4,                 46,               8,                     1),
            ('Cânula de Guedel Nº2',                            'Cânula orofaríngea para ventilação assistida.',                                    4,                 65,               3,                     1),
            ('Saco de Lixo Transparente 40L',                   'Saco para descarte seletivo de materiais recicláveis.',                            5,                 2,                10,                    1),
            ('Avental Camisola Hospitalar Tamanho GG',          'Camisola hospitalar tamanho GG.',                                                  4,                 104,              3,                     1),
            ('Curativo Transparente 10x10cm',                   'Curativo filme transparente estéril.',                                             4,                 65,               3,                     1),
            ('Caneta para Aplicação de Insulina 3ml',           'Caneta reutilizável para aplicação de insulina.',                                  4,                 91,               3,                     1),
            ('Haste Flexível Algodão c/100',                    'Hastes flexíveis para higiene e aplicação de medicamentos.',                       4,                 65,               10,                    1),
            ('Sonda Uretral Nº12',                              'Sonda uretral médio calibre.',                                                     4,                 65,               3,                     1),
            ('Sonda Uretral Nº08',                              'Sonda uretral para drenagem urinária.',                                            4,                 65,               3,                     1),
            ('Absorvente Higiênico c/ 8',                       'Absorvente pós-parto ou de uso ginecológico.',                                     4,                 71,               10,                    1),
            ('Copo Descartável para Água',                      'Copo descartável em poliestireno 200ml.',                                          4,                 31,               10,                    1),
            ('Aparelho de Barbear Descartável',                 'Lâmina para tricotomia pré-operatória e higiene.',                                 4,                 71,               3,                     1),
            ('Almotolia',                                       'Frasco plástico para acondicionamento e aplicação de líquidos.',                   4,                 39,               3,                     1),
            ('Lenço de Papel Caixa c/50',                       'Lenços descartáveis para higiene.',                                                4,                 71,               8,                     1),
            ('Abocath Nº14',                                    'Cateter intravenoso periférico para punção venosa.',                               4,                 65,               3,                     1),
            ('Abocath Nº20 com Dispositivo de Segurança',       'Cateter intravenoso com sistema de proteção contra perfurocortantes.',             4,                 65,               3,                     1),
            ('Scalp 19',                                        'Dispositivo com agulha borboleta para punção venosa.',                             4,                 65,               3,                     1),
            ('Cânula de Guedel Nº0',                            'Cânula orofaríngea para manutenção da via aérea.',                                 4,                 65,               3,                     1),
            ('Cânula de Guedel Nº1',                            'Cânula orofaríngea para manejo de via aérea.',                                     4,                 65,               3,                     1),
            ('Scalp 21',                                        'Dispositivo borboleta para punção venosa.',                                        4,                 65,               3,                     1),
            ('Cânula de Guedel Nº5',                            'Cânula orofaríngea para ventilação assistida.',                                    4,                 65,               3,                     0),
            ('Scalp 25',                                        'Scalp para punção pediátrica ou veias finas.',                                     4,                 65,               3,                     1),
            ('Sonda Foley 2 Vias Nº22',                         'Sonda uretral de grande calibre.',                                                 4,                 65,               3,                     1),
            ('Sonda Aspiração Traqueal s/ V Nº8',               'Sonda flexível para aspiração de vias aéreas.',                                    4,                 65,               3,                     1),
            ('Sonda Aspiração Traqueal c/ V Nº4',               'Sonda de pequeno calibre para aspiração.',                                         4,                 65,               3,                     1),
            ('Sonda Foley 3 Vias Nº16',                         'Sonda tripla para irrigação vesical.',                                             4,                 65,               3,                     1),
            ('Sonda Aspiração Traqueal c/ V Nº10',              'Sonda para aspiração traqueal com válvula.',                                       4,                 65,               3,                     1),
            ('Sonda Foley 3 Vias Nº22',                         'Sonda tripla para irrigação e drenagem.',                                          4,                 65,               3,                     1),
            ('Sonda Foley 3 Vias Nº24',                         'Sonda de grande calibre para irrigação vesical.',                                  4,                 65,               3,                     0),
            ('Sonda Nasogástrica Longa Nº04',                   'Sonda longa para descompressão gástrica.',                                         4,                 65,               3,                     1),
            ('Sonda Retal Nº28',                                'Sonda para drenagem alta.',                                                        4,                 65,               3,                     0),
            ('Sonda Retal Nº10',                                'Sonda para evacuação e drenagem.',                                                 4,                 65,               3,                     1),
            ('Sonda Retal Nº12',                                'Sonda retal de médio calibre.',                                                    4,                 65,               3,                     1),
            ('Sonda Nasogástrica Longa Nº20',                   'Sonda para drenagem gástrica.',                                                    4,                 65,               3,                     1),
            ('Sonda Retal Nº30',                                'Sonda de alto calibre para drenagem.',                                             4,                 65,               3,                     1),
            ('Sonda Uretral Nº04',                              'Sonda para sondagem uretral masculina ou feminina.',                               4,                 65,               3,                     0),
            ('Sonda Uretral Nº10',                              'Sonda para drenagem urinária.',                                                    4,                 65,               3,                     1),
            ('Sonda Nasogástrica Longa Nº22',                   'Sonda de alto calibre para drenagem.',                                             4,                 65,               3,                     0),
            ('Sonda Uretral Nº14',                              'Sonda para sondagem vesical.',                                                     4,                 65,               3,                     1),
            ('Luva Nitrílica Procedimento M',                   'Luva nitrílica não estéril.',                                                      4,                 24,               8,                     1),
            ('Luva Nitrílica Procedimento P',                   'Luva nitrílica tamanho P.',                                                        4,                 24,               8,                     1),
            ('Luva Vinil Procedimento P',                       'Luva de vinil para procedimentos.',                                                4,                 24,               8,                     1),
            ('Caneta Extra Fina para ECG',                      'Marcador técnico específico para traçados de eletrocardiograma.',                  6,                 87,               3,                     1),
            ('Luva Extra Pequena Látex',                        'Luva de látex tamanho extra pequeno.',                                             4,                 24,               8,                     0),
            ('Bateria CR2032 (Moeda)',                          'Bateria de lítio para glicosímetros e relógios.',                                  6,                 38,               3,                     1),
            ('Bateria LR41 (Botão)',                            'Bateria específica para termômetros digitais.',                                    6,                 38,               3,                     1),
            ('Espéculo Descartável M',                          'Espéculo ginecológico tamanho M.',                                                 4,                 65,               3,                     1),
            ('Espéculo Descartável P',                          'Espéculo ginecológico tamanho P.',                                                 4,                 65,               3,                     1),
            ('Kit Papanicolau Tamanho G',                       'Kit completo para coleta citológica ginecológica.',                                4,                 65,               3,                     1),
            ('Kit Papanicolau Tamanho M',                       'Kit estéril para coleta de citologia ginecológica.',                               4,                 102,              3,                     1),
            ('Lâmpada LED 12V/50W',                             'Lâmpada de reposição para focos e equipamentos médicos.',                          6,                 63,               3,                     0),
            ('Lanterna Clínica',                                'Instrumento portátil para exames de reflexo pupilar e oroscopia.',                 6,                 63,               3,                     1),
            ('Papel Grau Cirúrgico 10cm',                       'Embalagem para esterilização em autoclave com indicador químico.',                 4,                 78,               23,                    1),
            ('Papel Grau Cirúrgico 15cm',                       'Embalagem para esterilização em autoclave com indicador químico.',                 4,                 78,               23,                    1),
            ('Papel Termo 110mm x 20m Vídeo Print',             'Papel termosensível para exames de imagem.',                                       4,                 65,               23,                    1),
            ('Papel Termossensível ECG 80mm x 20m',             'Papel para impressões de ECG portátil.',                                           4,                 65,               23,                    1),
            ('Papel Termossensível Cardiotógrafo 150x90x150',   'Papel para registro de cardiotocografia.',                                         4,                 65,               27,                    1),
            ('Pilha Alcalina C (Média)',                        'Fonte de energia para equipamentos de médio porte.',                               6,                 38,               3,                     1),
            ('Polifix 2 Vias',                                  'Extensor multivias com clamp para infusão intravenosa simultânea.',                4,                 65,               3,                     1),
            ('Termo Higrômetro',                                'Aparelho para medir temperatura e umidade.',                                       4,                 91,               3,                     0),
            ('Torneira 3 Vias',                                 'Dispositivo conector para controle de fluxo de soluções intravenosas.',            4,                 65,               3,                     1),
            ('Tubo Endotraqueal 6,5',                           'Tubo para intubação endotraqueal.',                                                4,                 65,               3,                     1),
            ('Tubo Endotraqueal 7,0',                           'Tubo para manejo de via aérea.',                                                   4,                 65,               3,                     1),
