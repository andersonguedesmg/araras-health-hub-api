    ...
    public class UpdateEmployeeCommandValidator : AbstractValidator<UpdateEmployeeCommand>
    {
        ...
        public UpdateEmployeeCommandValidator(IEmployeeRepository employeeRepository)
        {
            ...
            RuleFor(command => command.Id)
                 .GreaterThan(0).WithMessage("O ID do funcionário é inválido.");
            ...
            RuleFor(command => command.Cpf)
                ...
                .Must(CpfValidatorHelper.IsValidCpf).WithMessage("O CPF informado é inválido.")
                .MustAsync(BeUniqueCpfForUpdate).WithMessage("Já existe um funcionário cadastrado com este CPF.");
        ...
        private async Task<bool> BeUniqueCpfForUpdate(UpdateEmployeeCommand command, string cpf, CancellationToken cancellationToken)
        {
