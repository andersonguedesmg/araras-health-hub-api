...
builder.Services.AddScoped<IPresentationFormRepository, PresentationFormRepository>();
...
builder.Services.AddAutoMapper(typeof(PresentationFormProfile).Assembly);
...
builder.Services.AddValidatorsFromAssembly(typeof(GetAllPresentationFormsQuery).Assembly);
