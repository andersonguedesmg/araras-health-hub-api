...
using ArarasHealthHub.Application.Features.Order.Dtos;
...
namespace ArarasHealthHub.Api.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        // public OrderController(IOrderRepository orderRepo, ApplicationDbContext dbContext, UserManager<ApplicationUser> userManager, IStockRepository stockRepo)
        // {
        ...
        //     if (user == null)
        //         return NotFound(new ApiResponse<ApplicationUser>(StatusCodes.Status404NotFound, ApiMessages.MsgAccountNotFound, null!));
        ...
        //         // CreatedByAccount = order.CreatedByAccount != null ? new ApplicationUser
        //         // {
        ...
        //         // ApprovedByAccount = order.ApprovedByAccount != null ? new ApplicationUser
        //         // {
        ...
        //         // SeparatedByAccount = order.SeparatedByAccount != null ? new ApplicationUser
        //         // {
        ...
        //         // FinalizedByAccount = order.FinalizedByAccount != null ? new ApplicationUser
        //         // {
