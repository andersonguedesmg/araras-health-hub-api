...
using ArarasHealthHub.Application.Features.Receiving.Dtos;
...
namespace ArarasHealthHub.Api.Controllers
{
    ...
    public class ReceivingController : ControllerBase
    {
        ...
        // public ReceivingController(IReceivingRepository receivingRepo, ApplicationDbContext dbContext, UserManager<ApplicationUser> userManager, IStockRepository stockRepo)
        // {
        ...
        //         // Account = receiving.Account != null ? new ApplicationUser
        //         // {
