...
namespace araras_health_hub_api.Dtos.Product
{
    public class UpdateProductRequestDto
    {
        ...
        [MinLength(14, ErrorMessage = "A Medida não pode ter menos de 14 caracteres.")]
        [MaxLength(15, ErrorMessage = "A Medida não pode ter mais de 15 caracteres.")]
        public string Measure { get; set; } = string.Empty;

        [Required(ErrorMessage = "A Categoria é obrigatória.")]
        [MinLength(14, ErrorMessage = "A Categoria não pode ter menos de 14 caracteres.")]
        [MaxLength(15, ErrorMessage = "A Categoria não pode ter mais de 15 caracteres.")]
